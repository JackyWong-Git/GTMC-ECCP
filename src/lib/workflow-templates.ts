...
### 收藏引导语`,
  ...
  // 模板 6：深度研究选题评估器
  {
    ...
    name: '深度研究选题评估器',
    description: '多轮搜索→提取→发现信息缺口→补充搜索→综合报告。像调查记者一样深挖一个选题，确保内容有足够的信息密度和差异化视角。',
    category: 'topic',
    icon: 'Search',
    tags: ['深度研究', '选题', '多轮搜索', '信息缺口', '综合报告'],
    difficulty: 'advanced',
    ...
    modules: [
      {
        type: 'web_search',
        name: '第一轮广度搜索',
        description: '广泛搜索选题相关的已有内容，建立基础认知',
        config: { maxResults: 12 },
        prompt: '搜索"{input}"的最新报道、行业分析、专家观点和数据报告',
        enabled: true,
      },
      {
        type: 'llm_analysis',
        name: '信息缺口识别',
        description: '分析已有信息，识别尚未覆盖的角度和信息缺口',
        config: {},
        modelId: 'doubao-seed-2-0-lite-260215',
        prompt: `请分析以下搜索结果，识别信息缺口：
...
2. 搜索关键词：...（目的：填补哪个缺口）`,
      ...
      },
      {
        type: 'web_search',
        name: '第二轮定向搜索',
        description: '针对信息缺口进行定向补充搜索',
        config: { maxResults: 8 },
        prompt: '搜索"{input}"的深度分析、独家观点、案例研究和数据对比',
        enabled: true,
      },
      {
        type: 'llm_analysis',
        name: '竞品内容分析',
        description: '分析竞品内容的覆盖情况和差异化空间',
        config: {},
        modelId: 'doubao-seed-2-0-lite-260215',
        prompt: `请分析以下两轮搜索结果，评估竞品内容覆盖情况：

第一轮搜索（广度）：{search_results}
第二轮搜索（定向）：{input}

请输出：
## 竞品内容覆盖图谱
| 角度/维度 | 已有内容数量 | 质量评估 | 差异化空间 |
|-----------|-------------|----------|-----------|

## 最佳差异化切入点
1. [切入角度] — 竞品覆盖度：低/中/高 — 我们的优势
2. [切入角度] — 竞品覆盖度：低/中/高 — 我们的优势
...
3. ...`,
      ...
      },
      {
        type: 'llm_generate',
        name: '深度研究报告生成',
        description: '综合所有信息生成完整的选题研究报告',
        config: {},
        modelId: 'qwen-3-5-plus-260215',
        prompt: `基于以下研究素材，生成一份完整的深度研究报告：
